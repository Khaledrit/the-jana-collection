...
required = [
    ...
    'data/collectionHelpers.js','data/privateJets.js','data/yachts.js','data/experiences.js',
    ...
    'studio/schemaTypes/privateJet.ts','studio/schemaTypes/yacht.ts','studio/schemaTypes/experience.ts','studio/structure.ts'
]
