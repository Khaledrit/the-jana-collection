...
async function servicePage(s){
 const villaDiscovery = s.slug === 'private-villas'
   ? await renderVillaDiscoverySection()
   : '';
...
async function openPropertyModal(slug, triggerEl){
 ...
 content.innerHTML = renderPropertyModalContent(property, propertyHelpers());
 modal.hidden = false;
